...
#RUN git clone git@github.com:8cH9azbsFifZ/GarminDB.git
RUN git clone https://github.com/tcgoetz/python-tcxparser.git
#RUN git clone git@github.com:8cH9azbsFifZ/python-tcxparser.git
RUN git clone https://github.com/tcgoetz/Fit.git
#RUN git clone git@github.com:8cH9azbsFifZ/Fit.git
RUN git clone https://github.com/tcgoetz/utilities.git
#RUN git clone git@github.com:8cH9azbsFifZ/utilities.git
